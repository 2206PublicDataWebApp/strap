...
<body>
	...
	<div class="content row" >
		...
		<div class="loginForm">
				...
				<button class="btn btn-dark" id="loginBtn" type="button">로그인</button><br><br>
				<button class="btn btn-dark" type="button" onclick="location.href='/member/enroll.strap'">회원 가입</button><br><br><br><br>
