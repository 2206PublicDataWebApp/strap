...
<body>
	<div class="registerForm">
		<form action="/member/register.strap" method="post">
			...
			<input type="text" id="memberJym" name="memberJym" size="25"><button type="button" onclick="showMap();">검색</button><br><br>
			<button>가입하기</button>
		</form>
	</div>
<script>
	function showMap(){
		window.open("/member/showMap.strap",null,"width=700,height=500,resizable=no");
	}
