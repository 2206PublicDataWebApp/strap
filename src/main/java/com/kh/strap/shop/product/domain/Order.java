...
public class Order {
	...
	public Order(int orderNo, int productNo, int orderGroup, int orderQty, int deliveryFee, int couponNo,
			int discountAmount, int finalCost, String memberId, String memberName, String memberEmail,
			...
			String deliveryStart, String deliveryComplete, String deliveryNo) {
		super();
	...
	public String toString() {
		return "Order [orderNo=" + orderNo + ", productNo=" + productNo + ", orderGroup=" + orderGroup + ", orderQty="
				+ orderQty + ", deliveryFee=" + deliveryFee + ", couponNo=" + couponNo + ", discountAmount="
				+ discountAmount + ", finalCost=" + finalCost + ", memberId=" + memberId + ", memberName=" + memberName
				+ ", memberEmail=" + memberEmail + ", memberPhone=" + memberPhone + ", address=" + address
				+ ", addressDetail=" + addressDetail + ", postNo=" + postNo + ", contactPhone=" + contactPhone
				...
				+ deliveryComplete + ", deliveryNo=" + deliveryNo + "]";
	}
